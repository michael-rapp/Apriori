...
/**
 * Tests the functionality of the class [Leverage].
 *
 * @author Michael Rapp
 */
class LeverageTest {
    ...
    fun testEvaluate() {
        ...
        assertEquals(support - bodySupport * headSupport, Leverage().evaluate(rule))
    }

    @Test
    fun testMinValue() {
        assertEquals(-java.lang.Double.MAX_VALUE, Leverage().minValue())
    }

    @Test
    fun testMaxValue() {
        assertEquals(1.0, Leverage().maxValue())
    }
